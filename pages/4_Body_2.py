...
gender_category_counts = df.groupby(['Product Category', 'Gender']).size().reset_index(name='Count')
...
for gender in gender_category_counts['Gender'].unique():
    gender_data = gender_category_counts[gender_category_counts['Gender'] == gender]
