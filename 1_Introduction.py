...
st.write("Product Category: The category of the product purchased, such as Electronics, Apparel, etc.")
st.write("Discount Availed: Indicates whether the customer availed any discount (Yes/No).")
st.write("Discount Name: Name of the discount applied (e.g., FESTIVE50).")
st.write("Discount Amount (INR): The amount of discount availed by the customer.")
